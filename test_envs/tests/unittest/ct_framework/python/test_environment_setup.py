...
class OllamaServerLifecycleTests(unittest.TestCase):
    ...
    @patch("test_envs.test_pipeline.environment_setup.configured_os", return_value="linux")
    @patch("test_envs.test_pipeline.environment_setup.sys.platform", "linux")
    ...
    @patch("test_envs.test_pipeline.environment_setup._ollama_ready", return_value=False)
    @patch("test_envs.test_pipeline.environment_setup._ollama_executable", return_value="ollama")
    ...
    @patch("test_envs.test_pipeline.environment_setup._refresh_check_file")
    @patch("test_envs.test_pipeline.environment_setup._run")
    @patch("test_envs.test_pipeline.environment_setup._ollama_ready", return_value=True)
