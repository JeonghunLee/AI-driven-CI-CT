...
| Test Result | 20260819_135500_514198_result.json |
...
| Item | Value |
|---|---|
| Summary | Test completed successfully with all assertions passed. The test case 'CT-USB-001' verified the USB bulk transfer functionality under local environment. |
