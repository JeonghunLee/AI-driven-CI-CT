...
| Test Result | 20260819_130825_278704_result.json |
...
| Item | Value |
|---|---|
| Summary | The test for CT-UART-001 in timing category completed successfully with all expected metrics met. |
