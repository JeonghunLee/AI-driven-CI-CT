...
| Test Result | 20260818_154439_582859_result.json |
...
| Item | Value |
|---|---|
| Summary | All tests completed successfully with no errors or warnings. The communication test on USB interface with Digilent equipment passed under local environment. |
