...
| Test Result | 20260819_133222_087918_result.json |
...
| Item | Value |
|---|---|
| Summary | Test USB Bulk Loopback passed successfully with 4 packets transferred. Equipment is configured correctly with Digilent and USB interface. |
