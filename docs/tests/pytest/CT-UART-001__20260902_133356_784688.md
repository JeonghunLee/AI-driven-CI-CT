...
| Test Result | 20260902_133356_784688_result.json |
...
| Item | Value |
|---|---|
| Summary | The test for CT-UART-001 completed successfully with all expected values within acceptable ranges. |
