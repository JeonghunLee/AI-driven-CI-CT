...
| Pandoc conversion | `test_envs.tools.pandoc_reporter` | `test_reports/pandocs/pytest/test_cases/<test-id>/<execution-id>_result.<format>`; DOCX uses `test_reports/pandocs/reference.docx` |
